...
- (void) updatePreferredFPS {
    float preferredFPS = UIScreen.mainScreen.maximumFramesPerSecond; // self.emulatorCore.frameInterval;
//    if (preferredFPS  < 10) {
      WLOG(@"Setting the preferred refresh rate frequency for the display to (%f)", preferredFPS);
//        preferredFPS = 60;
//    }
